      ...
      <div className="">
        ...
        <div>
          <a href="#_" className="relative inline-block text-lg group mt-6">
            <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-white transition-colors duration-300 ease-out border-2 border-primary rounded-lg group-hover:text-white">

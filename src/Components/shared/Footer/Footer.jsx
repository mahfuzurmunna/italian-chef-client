      ...
      <div className="bg-bg-nav min-h-[262px] py-20 ">
        <div className="grid lg:grid-cols-3 text-white text-center w-3/5 mx-auto gap-8 ">
          ...
          <div className=" text-center">
           ...
           <input type="text" placeholder='Enter Your Email' className='px-8 py-3 mt-4 text-center bg-white text-xl' />
           <button className='text-accent text-2xl border-b-2 border-accent block  mt-4 mx-auto hover:text-white hover:border-white 
           '>Subscribe</button>
          </div>
        </div>
      </div>
